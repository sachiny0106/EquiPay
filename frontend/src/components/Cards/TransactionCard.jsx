  ...
  const handleSubmit = async (e) => {
    ...
    const submitbutton =async()=>{
      try {
        ...
        const res = await axios.put(`https://equipay-gqsl.onrender.com/api/transactions/editTransaction/${transactionData._id}`, { transInput });
...
//  --------------function to delete --------------- 
  const handleDelete = async () => {
    try {
      const res = await axios.delete(`https://equipay-gqsl.onrender.com/api/transactions/deleteTransaction/${transactionData._id}`);
      console.log(res.data);
      console.log(transactionData)

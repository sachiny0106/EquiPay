...
const CategoryChart = ({ allCategories, categoryData, thememode }) => {
  ...
  const lightTheme = {
    colorText: 'black',
    income: 'rgba(79,180,192,0.5)',
    incomeBorder: 'rgba(79,180,192,1)',
    expenses: 'rgba(250,90,132,0.5)',
    expensesBorder: 'rgba(250,90,132,1)',
  };
//  ---------------- colors for the darkTheme ----------------------- 
  const darkTheme = {
    colorText: 'white',
    income: 'rgba(38,139,34,0.5)',
    incomeBorder: 'rgba(38,139,34,1)',
    expenses: 'rgba(168,42,42,0.5)',
    expensesBorder: 'rgba(168,42,42,1)',
  };

    ...
    useEffect(()=>{
      ...
      //fetching previous week's transaction data
       const getWeeklyData = async()=>{
        try{
            const res = await axios.get(`https://equipay-gqsl.onrender.com/api/transactions/getWeeklyTransaction/${user._id}`)
       ...
       const getMonthlyData = async()=>{
        try{
            const res = await axios.get(`https://equipay-gqsl.onrender.com/api/transactions/getMonthlyTransaction/${user._id}`)
       ...
       const getYearlyData = async()=>{
        try{
            const res = await axios.get(`https://equipay-gqsl.onrender.com/api/transactions/getYearlyTransaction/${user._id}`)
       ...
       const getCategory = async()=>{
        try{
          const res= await axios.get(`https://equipay-gqsl.onrender.com/api/transactions/getCategoryWiseTransaction/${user._id}`)

...
function Login({user,setUser}) {
  ...
  const submitFunction = (event) => {
    event.preventDefault(); 
      ...
      const Logi =async()=>{
        try{
          const res = await axios.post("https://equipay-gqsl.onrender.com/api/auth/signin",{username,email,password})
  ...
  const googlesekar = (req,res)=>{
    signInWithPopup(auth,provider).then((result)=>{
      ...
      axios
            .post("https://equipay-gqsl.onrender.com/api/auth/google", {

  ...
  const handlesavedit = (e,obj) => {
    ...
    const editSavings = async () => {
      try {
        ...
        const res = await axios.put(`https://equipay-gqsl.onrender.com/api/savings/editSaving/${obj._id}`, {sav});
...
const currenciData = UCurrency(currenci);
  ...
  const handleAddSaving = async (e) => {
    try {
      ...
      const res = await axios.post("https://equipay-gqsl.onrender.com/api/savings/addSaving", { saving });
...
// adding saving badge
  ...
  useEffect(()=>{
    ...
    const getSavings = async()=>{
      try{
        const res = await axios.get(`https://equipay-gqsl.onrender.com/api/savings/getSavings/${user._id}`)//add user Id
  ...
  const delsaving = async()=>{
    try{
        const res=await axios.delete(`https://equipay-gqsl.onrender.com/api/savings/deleteSaving/${selectedSavingId}`)
        console.log(res.data)
        setUpdateFlag((prev)=>!(prev))

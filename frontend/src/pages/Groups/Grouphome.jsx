...
console.log(groupData)
    ...
    const handleSubmit = async()=>{
      try{
        const res= await axios.post(`https://equipay-gqsl.onrender.com/api/group/splitbill`,{input})
  ...
  const handleApproved = async(memid)=>{
    try{
      const res=await axios.put(`https://equipay-gqsl.onrender.com/api/group/markapproved/${groupData._id}`,{userId:memid})
   ...
   useEffect(()=>{
    const getMembers = async()=>{
      try{
        const res = await axios.get(`https://equipay-gqsl.onrender.com/api/group/getmembers/${groupData._id}`)//add user Id

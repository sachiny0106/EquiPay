...
const SimplifyDebt = ({ user, thememode, toggle }) => {
    ...
    const getGroup = async () => {
        try {
            const res = await axios.get(`https://equipay-gqsl.onrender.com/api/group/getgroup/${id}`);
    ...
    const handleSubmit = (e) => {
        ...
        const simplify = async () => {
            try {
                const res = await axios.post(`https://equipay-gqsl.onrender.com/api/group/simplifyDebt/${id}`, { outputArray });
                setData(res.data);
            } catch (err) {
                console.log(err);
            }
    ...
    useEffect(() => {
        const getDebts = async () => {
            try {
                const res = await axios.get(`https://equipay-gqsl.onrender.com/api/group/getDebts/${id}`);
                setData(res.data);
            } catch (err) {
                console.log(err);
            }
    ...
    const handleAddComment = async () => {
        try {
            const res = await axios.post(`https://equipay-gqsl.onrender.com/api/group/addcomment`, {
                userId: user._id,
                text: commentText,
                groupId: id,
    ...
    const getComments = async () => {
        try {
            const response = await axios.get(`https://equipay-gqsl.onrender.com/api/group/getcomments/${id}`);
    ...
    const getMembers = async () => {
        try {
            const res = await axios.get(`https://equipay-gqsl.onrender.com/api/group/getmembers/${id}`);
                                    ...
                                    <div key={debt[0]} className='flex items-center bg-gray-300 rounded-2xl justify-between m-2 w-[95%] dark:bg-[#282828] text-sm'>
                                        ...
                                        {user?.username === debt[1] && (
                                            <button onClick={async () => {
                                                try {
                                                    const res = await axios.post(`https://equipay-gqsl.onrender.com/api/group/approveDebt/${id}`, debt);

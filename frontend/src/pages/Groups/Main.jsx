...
export const Main = ({user,setUser,thememode,toggle,groupData,setgroupData}) => {
  console.log(groupData)
    ...
    const handleSendRequest = async()=>{
      try{
        const res= await axios.put(`https://equipay-gqsl.onrender.com/api/friend/sendRequest/${user._id}`,{friendName})
    ...
    const handleSubmit =e=>{  
      ...
      const addgroup =async()=>{
          try{
            console.log(groupInput)
            const res = await axios.post("https://equipay-gqsl.onrender.com/api/group/creategroup",{groupInput: { ...groupInput, groupCode: groupCode },})
    ...
    const handleJoin =e=>{  
      ...
      const addgroup =async()=>{
          try{
            console.log(JoingCode)
            const res = await axios.post("https://equipay-gqsl.onrender.com/api/group/joingroup",{joincode})
            console.log(res.data.newgroup)
            setgroupflag((prev)=>!(prev))
            console.log(groupData)
          }catch(err){
    ...
    useEffect(()=>{
      ...
      const getGroups = async()=>{
        try{
          const res = await axios.get(`https://equipay-gqsl.onrender.com/api/group/getgroups/${user._id}`)//add user Id

...
function Dues({ user, thememode, toggle,setUser }) {
  ...
  const mailsendstart = async () => {
    try {
      ...
      console.log(reqmail);
      const res = await axios.post('https://equipay-gqsl.onrender.com/api/mail/sendstartmail', { reqmail });
  ...
  const mailsendrecurring = async (recurring) => {
    try {
      ...
      console.log(reqmail);
      const res = await axios.post('https://equipay-gqsl.onrender.com/api/mail/sendmailrecurring', { reqmail, duedate, recurring });
      alert('Message Sent Successfully');
    } catch (err) {
...
// ----------------------- Submit ------------------- 
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('https://equipay-gqsl.onrender.com/api/bills/addBill', { dueItem });
  ...
  useEffect(()=>{
    const getBills = async () => {
      try {
        const res = await axios.get(`https://equipay-gqsl.onrender.com/api/bills/getBills/${user._id}`);
        console.log(res.data);
...
const handleSubmitBill = (e,obj) => {
  ...
  const editBill = async () => {
    try {
      ...
      const res = await axios.put(`https://equipay-gqsl.onrender.com/api/bills/editBill/${obj._id}`, {Bill});
      console.log(res.data);
      setBill({
      userId: user._id,
      titleedit: '',
...
const handleDelete = () => {
  const delBill = async () => {
    try {
      ...
      const res = await axios.delete(`https://equipay-gqsl.onrender.com/api/bills/deleteBill/${selecteddue}`);
      console.log(res.data);
      setbillflag((prev)=>!(prev))
